...
public class DiseaseVO {
	...
	public String getDiseasehospitalkind() {
		return diseasehospitalkind;
	}
	public void setDiseasehospitalkind(String diseasehospitalkind) {
		this.diseasehospitalkind = diseasehospitalkind;
	}
