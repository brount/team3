...
var gnbSvcs = {
	...
	"svc_lst2" : [{"id":"krdic","name":"국어사전","sname":"국어","link":"http://krdic.naver.com/"},
		...
		{"id":"papago","name":"파파고","sname":"파파고","link":"https://papago.naver.com/"}],
...
var gnbWholeSvc = [
	...
	{"name":"파파고", "query":["파파고"], "link":"https://papago.naver.com/", "clickCd":"gnbSR_papago"},
	...
	{"name":"한영번역기", "query":["한영번역기"], "link":"https://papago.naver.com/?sk=ko&tk=en", "clickCd":"gnbSR_papago_en"},
	{"name":"한일번역기", "query":["한일번역기"], "link":"https://papago.naver.com/?sk=ko&tk=ja", "clickCd":"gnbSR_translate_jp"},
	...
	{"name":"회원가입", "query":["회원가입"], "link":"https://nid.naver.com/user/join.html?lang=ko_KR", "clickCd":"gnbSR_join"}
];
...
gnb_html_buffer.push("</div>");
gnb_html_buffer.push("</div>");
gnb_html_buffer.push("<div id=\"gnb_search_lstwrp\" class=\"gnb_search_lstwrp\">");
...
gnb_html_buffer.push("</div>");
gnb_html_buffer.push("</div>");
gnb_html_buffer.push("<div class=\"gnb_banner\"><a href=\"https://campaign.naver.com/npay/rediret/index.nhn\" class=\"gnb_service_event\"><img id=\"gnb_promo\" alt=\"첫 계좌등록 시 1천원 적립!\" width=\"265\" height=\"47\" src=\"https://ssl.pstatic.net/static/common/gnb/2014/promo_npay.png\"></a></div>");
		...
		addService : function(){
			...
			for (var i = 0; i < gnbFavoriteListArr.length; i++) {
				if(this.selectedSvcArr[i]){
					...
					gnbFavoriteListArr[i].innerHTML = "<a href=\"#\" onclick=\"gnbMoreLayer.showMoreLayer(); return false;\"><span class=\"ic_add\"></span>추가</a>";
				}
			};
			if (typeof(ncd)!="undefined") {
