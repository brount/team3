	...
	<div class="row">
		...
		<div class="panel panel-primary">
		    ...
		    <table class="table" border="1" >
				...
				<tr>
					<td>
						▣ 진단명<br><br><textarea rows="5" cols="120">스트레스성 우울증</textarea>
					</td>
				</tr>
				<tr>
					<td>
						▣ 병력 및 소견<br><br><textarea rows="5" cols="120">지나친 야근으로 인하여 피로가 누적된것으로 보임</textarea>
					</td>
				</tr>
				<tr>
					<td>
						▣ 의뢰 내용<br><br><textarea rows="5" cols="120">혈액 검사와 소변검사를 요청함</textarea>
					</td>
				</tr>
		    </table>
