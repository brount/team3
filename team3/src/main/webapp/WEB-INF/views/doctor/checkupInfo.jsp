		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 col-md-9">
					<div class="well">
						<h3>
							<small style="font-family: 'Do Hyeon', sans-serif; font-size: 25px;">검사의뢰목록 ></small> 검사 의뢰서 <small style="font-family: 'Do Hyeon', sans-serif; font-size: 25px;">> 검진서 등록</small>
						</h3>
						<br>
						<div>
							<div class="panel panel-primary">
								...
								<table class="responstable">
									...
									<tr>
										<td colspan="2">
											<textarea name="checkup_name" rows="5"
												readonly="readonly" style="resize: none; width: 100%;">${checkDto.checkup_name}</textarea>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="2">
											<textarea name="checkup_name" rows="5"
												readonly="readonly" style="resize: none; width: 100%;">${checkDto.checkup_opinion}</textarea>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="2">
											<textarea name="checkup_name" rows="5"
												readonly="readonly" style="resize: none; width: 100%;">${checkDto.checkup_contents}</textarea>
										</td>
									</tr>
							...
							<div style="display: table; margin: 0 auto;">
								<input type="button" class="btn btn-dark-blue" value="검진서 등록" style="margin-right: 5px;"
									onclick="window.location='checkupAdd?checkuplist=${checkuplist}&doctorno=${docDto.doctorno}&kind=${kind}'">
								<input type="button" class="btn btn-dark-blue" value="목록가기" style="margin-left: 5px;"
