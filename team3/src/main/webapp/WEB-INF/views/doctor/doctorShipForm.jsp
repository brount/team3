...
<div class="well">
  <form class="form-horizontal" action="inputPro" method="post" name="reg_form" enctype="multipart/form-data">
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            ...
            <input name= "dupchk" type="button" 
					value="중복확인" onclick="doctorconfirmId();">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div style="margin:0 auto; display:table;">
          <button type="submit" class="btn btn-warning" style="margin-right:5px;">가입<span class="glyphicon glyphicon-send"></span></button>
        <button type="reset" class="btn btn-warning" >취소<span class="glyphicon glyphicon-send"></span></button>
         <a href="main"><button type="button" class="btn btn-warning" style="margin-left:5px;">메인<span class="glyphicon glyphicon-send"></span></button></a>
        </div>
      </div>
    </fieldset>
  </form>
