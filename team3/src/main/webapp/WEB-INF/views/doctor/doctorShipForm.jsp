  ...
  <form class="form-horizontal" action=" " method="post"  id="reg_form">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input  name="id" placeholder="아이디를 입력해주세요" class="form-control" type="text"><input type="button" value="중복확인">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <button type="submit" class="btn btn-warning" >가입<span class="glyphicon glyphicon-send"></span></button>
