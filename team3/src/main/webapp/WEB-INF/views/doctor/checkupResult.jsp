						...
						<div class="panel panel-primary">
							...
							<table class="table table-striped table-hover" border="1">
								...
								<tbody>
									...
									<tr>
										<td>비만도</td>
										<td>${CheckDto.fatness}BMI</td>
										<td></td>
										<td>저체충 18.5 미만<br>정상 : 18.5이상 ~ 23미만<br>과체중 :
											23이상~25미만<br>비만 : 25이상~30미만 <br> 고도비만 30이상
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td rowspan="2">고혈압</td>
										<td>혈압(최고)</td>
										<td>${CheckDto.bloodpremax}mmHg</td>
										<td></td>
										<td>120이하</td>
									</tr>
									<tr>
										<td>혈압(최저)</td>
										<td>${CheckDto.bloodpremin}mmHg</td>
										<td></td>
										<td>80이상</td>
									</tr>
									<tr>
									...
									<tr>
										<td>요잠혈</td>
										<td>${CheckDto.occulthematuria}</td>
										<td>음성</td>
										<td>약양성±</td>
									</tr>
