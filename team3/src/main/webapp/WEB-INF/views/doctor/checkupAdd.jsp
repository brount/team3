		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 col-md-9">
					<div class="well">
						<h3>
							<small style="font-family: 'Do Hyeon', sans-serif; font-size: 25px;">검사의뢰목록 > 검사의뢰서 ></small> 검진서 등록
						</h3>
						<br>
									...
									<tbody>
										...
										<c:if test="${kind=='3'}">
											<tr>
												...
												<td style="color: green;">남:12~13 / 16~17<br>여:10~11 / 15~16
												</td>
											</tr>
											...
											<tr>
												<td>고혈압<br> <br> 이상지질<br>혈증<br> <br>동맥경화
												</td>
												<br>
												<td>총<br>콜레스테롤
												</td>
