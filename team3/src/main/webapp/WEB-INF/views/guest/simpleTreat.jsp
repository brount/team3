...
<link rel="stylesheet" type="text/css"
	href="/medical/resources/css/css/default.css" />
							...
							<fieldset>
										...
										<div class="input-group">
											<div style="margin-left: 10px;">
												...
												<label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="두통" />
													두통
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="발열" />
													발열
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="기침" />
													기침
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk"
													value="메스꺼움" /> 메스꺼움
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="복통" />
													복통
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="구토" />
													구토
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="설사" />
													설사
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="근육통" />
													근육통
												</label> <label> <input type="checkbox"
													class="option-input checkbox" name="symptomchk" value="인후통" />
													인후통
												</label>
								...
								<div style="margin: 0 auto; display: table;">
									...
									<button type="button" class="btn btn-dark-blue"
										onclick="simple();">
										검색 <span class="glyphicon glyphicon-send"></span>
									</button>
								</div>
							</fieldset>
						</form>
