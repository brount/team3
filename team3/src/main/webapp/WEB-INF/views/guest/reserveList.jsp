								...
								<tr>
									<th align="center"><c:if test="${cnt>0 }">
											...
											<c:if test="${startPage > pageBlock }">
												<a href="reserveList" style="font-size: 15px;">[◀◀]</a>
												<a href="reserveList?pageNum=${startPage - pageBlock }" style="font-size: 15px;">[◀]</a>
											</c:if>
											...
											<c:forEach var="i" begin="${startPage }" end="${endPage }">
												...
												<c:if test="${i != currentPage}">
													<a href="reserveList?pageNum=${i }" style="font-size: 15px;">[${i}]</a>
												</c:if>
											</c:forEach>
											...
											<c:if test="${pageCount > endPage }">
												<a href="reserveList?pageNum=${startPage + pageBlock }" style="font-size: 15px;">[▶]</a>
												<a href="reserveList?pageNum=${pageCount}" style="font-size: 15px;">[▶▶] </a>
											</c:if>
										</c:if>
									</th>
								</tr>
