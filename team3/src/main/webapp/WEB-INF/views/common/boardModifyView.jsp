	...
	<fieldset style="width: 800px; margin:0 auto">
		...
		<table   class="table table-striped table-hover" border="1" align="center" id="board" >
			...
			<tr>
				<th>제목</th>	
				<td>
					<input class="input" type="text" name="boardtitle" maxlength="50" style="width=270px" value="${dto.boardtitle }">
				</td>		
			</tr>	
			...
			<tr>
				<th>내용</th>	
				<td>
					<textarea  class="input" name="boardcontent" style="width=270px" rows="10" cols="40">${dto.boardcontent }</textarea>
				</td>		
			</tr>	
