					      ...
					      <div class="option">
					          <div>
					              <form onsubmit="searchPlaces(); return false;">
					                  키워드 : <input type="text" value="병원" id="keyword" size="15"> 
		                            ...
		                            <tbody>
		                              <c:if test="${cnt>0 }">
										<c:forEach var="dto" items="${dtos }">
												<tr id="placesList">
													<%-- <th onclick="hospitalMove();"><h3>${number }. ${dto.hospitalname}</h3></th> --%>										
												</tr>
												<%-- <tr>
													<td>
												...
												<tr>
													<td>
														▶진료과목 : ${dto.hospitalkind1 } ${dto.hospitalkind2 } ${dto.hospitalkind3 }
													</td>										
												</tr>
												<tr>
													<td>
				...
				if (navigator.geolocation) {
					...
					function searchPlaces() {
					    ...
					    if (!keyword.replace(/^\s+|\s+$/g, '')) {
 						...
 						keyword = s + document.getElementById('keyword').value;
					...
					function getListItem(index, places) {
					    ...
					    itemStr = '<td><span class="markerbg marker_' + (index+1) + '"></span>' +
					                "<div class=\"info\" onclick=\"hospitalMove('"+places.phone+"')\">" +
