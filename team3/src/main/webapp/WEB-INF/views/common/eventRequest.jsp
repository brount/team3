		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 col-md-9">
					<div class="well">
						<div>
							<form class="form-horizontal" action="eventAdd" method="post"
								id="reg_form" enctype="multipart/form-data">
										...
										<div class="col-md-7 inputGroupContainer">
											<div class="input-group">
												...
												<input id="date1" name="date1" class="form-control" type="date"
													onchange="date();" style="font-size: 20px;" required>
												<input id="date2" name="date2" class="form-control"
													type="date" style="font-size: 20px;" readonly="readonly">
											</div>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
										...
										<div class="col-md-7 inputGroupContainer">
											<div class="input-group">
												...
												<input name="thumbnail" class="form-control" type="file"
													style="padding: 1px; font-size: 16px;" required>
											</div>
										</div>
									</div>
										...
										<div class="col-md-7 inputGroupContainer">
											<div class="input-group">
												...
												<textarea class="form-control" rows="8" name="content"
													placeholder="이벤트 내용을 적어주세요 " style="resize: none;" required></textarea>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div style="display: table; margin: 0 auto;">
											<button type="submit" class="btn btn-dark-blue" style="margin-right: 5px;">
												신청 <span class="glyphicon glyphicon-send"></span>
											</button>
											<button type="reset" class="btn btn-dark-blue">
												취소 <span class="glyphicon glyphicon-send"></span>
											</button>
											<button type="button" class="btn btn-dark-blue" style="margin-left: 5px"
												onclick="window.location='eventList'">
												메인 <span class="glyphicon glyphicon-send"></span>
											</button>
										</div>
									</div>
								</fieldset>
