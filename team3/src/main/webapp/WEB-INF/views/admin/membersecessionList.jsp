...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">회원관리 - 탈퇴회원목록</h1>
					<!-- 페이지 제목 -->
				</div>
				<!-- /.col-lg-12 -->
			</div>
							...
							<div class="pull-right">
								<div class="btn-group">
									...
									<button type="button" class="btn btn-dark-blue"
										...
										onclick="return memberdeleteCheck();">삭제
									</button>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-lg-4">
									<div class="table-responsive">
											...
											<tbody>
												<c:if test="${cnt > 0}">
													...
													<c:forEach var="dto" items="${dtos}">
														<tr>
															<td class="center">
																<input type="checkbox" name="checkOne" value="${dto.guestNo}">
															</td>
															<td>${dto.guestNo}</td>
															<td>${dto.guestid}</td>
															<td>${dto.guestname}</td>
										...
										<form action="membersecessionSearchList" class="search_box"
