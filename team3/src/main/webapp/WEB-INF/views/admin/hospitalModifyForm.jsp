		...
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form" action="hospitalModifyPro" name="hosModifyForm"
								onsubmit="return hosModifyChk()">
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" style="resize: none;"
										name="hospitalinstruction">${dto.hospitalinstruction}</textarea>
								</div>

								<button type="submit" class="btn btn-default">수정</button>
								<button type="reset" class="btn btn-default"
									onclick="window.location='hospitalList'">취소</button>
							</form>
						</div>
						<!-- /.col-lg-6 (nested) -->
					</div>
