	        	...
	        	<div class="row">
	            	...
	            	<!-- col-lg-12 -->
							...
							<div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" action="diseaseList">
                                      		<!-- 검색 -->
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">기침
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">가래
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">발열
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value=""> 약물치료
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value=""> 기치료
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value=""> 침
                                                    </label>
                                                </div>
                                            </div>
                                      		...
                                      		<div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="">심근경색
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value=""> 체온유지
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value=""> 식이요법
                                                    </label>
                                                </div>
                                            </div>
