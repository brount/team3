					...
					<div class="col-lg-9">
						<form class="form-horizontal" action="eventModifyPro" method="post" id="reg_form" enctype="multipart/form-data">
							...
							<div class="input-group">
								<label>제목</label>
								<input name="title" class="form-control" type="text" value="${dto.advertisementTitle }" required>
							</div>
							...
							<div class="input-group">
								...
								<div class="input-group">
									...
									<input id="date2" name="date2" class="form-control" type="date" value="${dto.advertisementEnd }" readonly>					           
								</div>		
