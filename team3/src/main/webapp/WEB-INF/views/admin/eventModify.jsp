			...
			<div class="row">
				...
				<div class="container">
					<div class="col-lg-9">
						...
						<form class="form-horizontal" action="eventModifyPro" method="post" id="reg_form" enctype="multipart/form-data">
					      ...
					      <div class="form-group">
					        ...
					        <div class="col-md-6  inputGroupContainer">
					          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
					            <input name="title" placeholder="제목을 입력해주세요" class="form-control" type="text" value="${dto.advertisementTitle }">
					          </div>
					        </div>
					      </div>
					      ...
					      <div class="form-group">
					        ...
					        <div class="col-md-6  inputGroupContainer">
					          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
					             <input id="date1"  name="date1" class="form-control" type="date" onchange="date();" value="${dto.advertisementStart }">
					             <input id="date2" name="date2" class="form-control" type="date" value="${dto.advertisementEnd }">					           
					          </div>		
					      ...
					      <div class="form-group">
					        ...
					        <div class="col-md-6  inputGroupContainer">
					          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
					            <textarea class="form-control" rows="8" name="content" placeholder="이벤트 내용을 적어주세요 " style="resize: none;">${dto.advertisementContents }</textarea>
					          </div>
					        </div>
					      </div>
