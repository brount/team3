                                  ...
                                  <div class="col-lg-6">
									<form role="form" action="exerciseModifyPro" name="exerciseForm" enctype="multipart/form-data" method="post" onsubmit="return exerciseChk()">
										...
										<div class="form-group input-group">
											<label>운동명</label>
											<input type="text" class="form-control" name="exerciseName" value="${dto.exerciseName }"> 
										</div>
										...
										<div class="form-group">
											<label>운동정의</label>
											<textarea class="form-control" rows="3" name="exerciseDefine">${dto.exerciseDefine}</textarea>
										</div>
										...
										<div class="form-group">
											<label>운동부위</label>
											<textarea class="form-control" rows="3" name="exercisePart">${dto.exercisePart}</textarea>
										</div>
