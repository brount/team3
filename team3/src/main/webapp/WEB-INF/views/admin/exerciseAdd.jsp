	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<!-- col-lg-12 -->
				<div class="col-lg-12">
					<h1 class="page-header">운동정보추가</h1>
					<!-- 페이지 제목 -->
				</div>
				<!-- col-lg-12 -->
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form" action="exerciseAddPro" name="exerciseForm"
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" style="resize: none;"
										name="exerciseDefine"></textarea>
								</div>

								<div class="form-group">
									<label>운동방법</label>
									<textarea class="form-control" rows="3" style="resize: none;"
										name="exerciseMethod"></textarea>
								</div>

								<div class="form-group">
									<label>운동부위</label>
									<textarea class="form-control" rows="3" style="resize: none;"
										name="exercisePart"></textarea>
								</div>

								<div class="form-group">
									<label>주의할점</label>
									<textarea class="form-control" rows="3" style="resize: none;"
										name="exerciseCaution"></textarea>
								</div>
