							...
							<div class="row">
								<div class="col-lg-6">
									<form role="form" action="membersanctionManagePro"
										name="manageForm" onsubmit="return sanctionChk()">
										<input type="hidden" name="pageNum" value="${pageNum}">
										<div class="form-group input-group">
											<label>회원번호</label>
											<input type="text" class="form-control"
												id="guestNo" name="guestNo" value="${dto.guestNo}" readonly>
										</div>
										<div class="form-group input-group">
											<label>회원명</label>
											<input type="text" class="form-control"
												id="guestname" name="guestname" value="${dto.guestname}" readonly>
										</div>

										<div class="form-group input-group">
											<label>회원ID</label>
											<input type="text" class="form-control"
												id="guestid" name="guestid" value="${dto.guestid}" readonly>
										</div>
